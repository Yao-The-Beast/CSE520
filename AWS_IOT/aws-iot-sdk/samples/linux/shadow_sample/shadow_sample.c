...
#define ROOMTEMPERATURE_LOWERLIMIT 28.0f
...
static void simulateRoomTemperature(float *pRoomTemperature, bool *windowOpen) {
...
int main(int argc, char **argv) {
	...
	while(NETWORK_ATTEMPTING_RECONNECT == rc || NETWORK_RECONNECTED == rc || SUCCESS == rc) {
		...
		simulateRoomTemperature(&temperature, &windowOpen);
